...
const assignment = "12 - Sets";

const HTMLelements = document.querySelectorAll(".setup");

HTMLelements[0].textContent = assignment;
HTMLelements[1].textContent = assignment;

const mapNodes = (string, ...e) => {
  e.map((i) => (i.textContent = string));
};

mapNodes(assignment, HTMLelements);
...
uniqueKeywords.add("python").add("php");
...
console.log(uniqueKeywords);
console.log(
  'is "business in uniqueKeywords?: "',
  uniqueKeywords.has("business")
);
...
// set intersections (entries present in both a + b)

const ingredientsIntersection = italianFoods.intersection(mexicanFoods);

console.log(ingredientsIntersection);

// set unions (all of a + all of b)

const foodUnion = italianFoods.union(mexicanFoods);
const foodUnionArr = [...foodUnion];

console.log(foodUnion);
console.log(foodUnionArr);

// unique italianFood(entries unique to a)

const onlyItalianFood = italianFoods.difference(mexicanFoods);

const onlyMexicanFood = mexicanFoods.difference(italianFoods);

console.log(onlyItalianFood);
console.log(onlyMexicanFood);

// symmetricDifference (entries unique to a + entries unique to b)

const uniqueItalianAndUniqueMexicanFoods =
  italianFoods.symmetricDifference(mexicanFoods);

console.log(uniqueItalianAndUniqueMexicanFoods);
