...
const assignment = "15 - Strings part 1";
...
/*
// console.log(books[0].ISBN.slice(6, 7));
// console.log(books[0].ISBN.slice(4, 5));
// console.log(books[0].ISBN.slice(9, 10));
// console.log(books[0].ISBN.slice(8, 9));
*/
...
/* 
// console.log(books[0].keywords[0]);
*/
...
// takes in all books
function isContributorFromBooks(books) {
  for (const i of books) {
    if (!Array.isArray(i.author)) {
      i.author.indexOf("(Contributor)") !== -1
        ? console.log(i.author, true)
        : console.log(i.author, false);
    } else if (Array.isArray(i.author)) {
      for (const e of i.author) {
        e.indexOf("(Contributor)") !== -1
          ? console.log(e, true)
          : console.log(e, false);
      }
    }
...
isContributorFromBooks(books);

//takes in author
function isContributorFromName(name) {
  console.log(name, name.indexOf("(Contributor)") !== -1 ? true : false);
}

isContributorFromName("Dexter J. Booth");
isContributorFromName("Julie Sussman (Contributor)");
